...
using ShoppingCartApi.Providers.TokenProvider;
using System;
...
namespace ShoppingCartApi
{
    public partial class Startup
    {
        ...
        {
            string newPassword = Security.getSHA256(password);
            string newEmail = email;
            if (context.Users.Where(u => u.Email == email && u.Password == Security.getSHA256(password)).Count() > 0)
            {
